                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td style="text-align: center;">
                                   <a data-toggle="modal" data-target="#updateDataSHModal" data-whatever="<?php echo $row_Recordset['username'];?>" class="btn btn-info btn-sm active" role="button" aria-pressed="true">PENDAFTARAN</a>
                                </td>
                                </tr>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <?php }?>
                                   ...
                                   <td><a data-toggle="modal" data-target="#kemaskiniJudulSHModal" data-whatever="<?php echo $dataSH['kodPembekal'];?>" class="btn btn-warning btn-sm active" role="button" aria-pressed="true"><i class="fas fa-wifi"></i></a></td>
