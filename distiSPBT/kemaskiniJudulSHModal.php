...
?>
  ...
  <div class="container">  
                    ...
                    <br />
                    <div class="table-responsive">
                        <h4 class="card-title" style="font-size:14px;">*Tandakan <strong>checkbox</strong> berikut untuk menghapus rekod judul yang tidak berkaitan dan klik butang <strong>Hapus</strong></h4>
