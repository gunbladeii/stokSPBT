...
$year = date('Y');
    ...
    $refID5 = $mysqli->query("SELECT rekodPemantauan.id,FORMAT(SUM(CASE WHEN (dataJudul.harga * rekodPemantauan.bukuLebihan) > 0 THEN (dataJudul.harga * rekodPemantauan.bukuLebihan) ELSE 0 END),2) AS harga 
      FROM 
      ((rekodPemantauan 
