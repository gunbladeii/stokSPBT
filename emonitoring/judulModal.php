...
if (isset($_POST['submit'])) {
  $mysqli->query ("INSERT INTO `rekodPemantauan` (`kodSekolah`,`kodJudul`,`bukuLebihan`,`bukuStok`,`bukuRosak`,`bukuRosakMurid`) VALUES ('$kodSekolah2','$kodJudul2','$bukuLebihan','$bukuStok','$bukuRosak','$bukuRosakMurid')");
