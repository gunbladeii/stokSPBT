    ...
    <!-- Begin daftarJudulSH Modal -->
      <div class="modal fade" id="daftarJudulSHModal">
        <div class="modal-dialog">
          <div class="modal-content bg-light">
            <div class="modal-header">
              <h4 class="modal-title">Rekod Pemantauan Pembekalan Mengikut Judul</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                            ...
                            <?php if(!empty($dataSH)){?>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><a data-toggle="modal" data-target="#daftarJudulSHModal" data-whatever="<?php echo $dataSH['namaPembekal'];?>" class="btn btn-warning btn-sm active" role="button" aria-pressed="true"><i class="fas fa-sign-in-alt"></i></a></td>
