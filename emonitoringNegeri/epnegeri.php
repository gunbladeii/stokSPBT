              ...
              <div class="card-body p-0">
                          ...
                          <div class="table-responsive">
                            ...
                            <?php if(!empty($dataSH)){?>
                              ...
                              <tfoot>
                                <tr>
                                    <td colspan="7" align="right"><a class="btn btn-warning btn-sm active" role="button" aria-pressed="true">NiNilai Sebut Harga: <?php echo 'RM'.number_format($dataSH2['sumnilaiSH'],2);?></a>
                                    </td>
                                </tr>
                              </tfoot>
                             </table>
