...
$query = "SELECT dataJudulPenerbit.bilnaskhahpesan,dataJudulPenerbit.bilnaskhahbekal,IF(dataJudulPenerbit.bilnaskhahpesan > dataJudulPenerbit.bilnaskhahbekal,'BELUM SELESAI', 'SELESAI') AS statusbekal,dataJudulPenerbit.id,dataJudulPenerbit.timestamp,dataJudulPenerbit.kodpembekal, dataSH.negeri,dataJudulPenerbit.kodjudul, dataSHJudul.judul FROM 
((dataJudulPenerbit 
