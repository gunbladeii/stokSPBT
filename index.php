...
<body class="hold-transition login-page">
  ...
  <div class="login-box shadow p-3 mb-5 bg-white rounded">
    <div class="login-logo">
      <a href="../../index.php"><img src="emonitoring/img/logoMySPBT.png" style="width:60%;opacity: .8"></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form role="form" method="POST" class="login-form" name="prosesLogin">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <input type="submit" name="submit" class="btn btn-primary btn-block btn-flat text-wrap" value="Login">
            </div>
            <!-- /.col -->
          </div>
        </form>
