                ...
                <tr>
                  ...
                  <td>
                   <div class="form-group">
                    <div align="center">
                    <a class="btn btn-info" href="mainBoss.php?kodSekolah=<?php echo $kodSekolah?>&namaSekolah=<?php echo $namaSekolah?>&jenisAliran=<?php echo $jenisAliran2?>">Kemaskini Maklumat Judul</a></td>
                    <td>
                    </div>
                  </div>
                </td>
