...
$MM_restrictGoTo = "../indexPublisher.php";
...
<head>
  ...
  <title>Admin AFMS | Invoice</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../../payroll.php">Staff Payroll</a></li>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  To
                  <address>
                    <strong>Ali bin Ahmad</strong><br>
                    N0.7, Balakong<br>
                    Cheras, Selangor<br>
                    Phone: (60) 013-1234567<br>
                    Email: ali.ahmad@example.com
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  <b>Payment Voucher #007612</b><br>
                  <br>
