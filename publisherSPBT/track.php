<html><head>
  ...
  <body>
    ...
    <div id="app"><div class="sidebar"><section class="cameras"><h2>Cameras</h2> <ul><!----> <li><span title="FaceTime HD Camera (Built-in)" class="active">FaceTime HD Camera (Built-in)</span> <!----></li></ul></section> <section class="scans"><h2>Scans</h2> <!----> <ul><li title="" class=""></li></ul></section></div> <div class="preview-container"><video id="preview" autoplay="autoplay" class="active" style="transform: scaleX(-1);"></video></div></div>
